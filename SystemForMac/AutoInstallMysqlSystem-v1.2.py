...
# @Time    : 2020/1/27 
# @Author  : lee
# @FileName: AutoInstallMysqlSystem-v1.2.py
# @Desc    :
#
...
class Application(Frame):
    ...
    def design_buttonBox(self):
        ...
        self.fm_foot3 = Button(self.fm2, text='批量加载数据', width=10, height=3, command=self.loadData)
        self.fm_foot4 = Button(self.fm2, text='连接测试', width=10, height=3, command=self.testLink)
        self.fm_foot5 = Button(self.fm2, text='全部安装', width=10, height=3, command=self.start_install)
        self.fm_foot6 = Button(self.fm2, text='全部卸载', width=10, height=3, command=self.start_uninstall)
